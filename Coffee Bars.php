...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item pt-2 pb-2">
                    <a href="Coffee%20Bars.php" class="nav-link text-white"><span class="fa fa-coffee"></span> Coffee bars</a>
                </li>
                <li class="nav-item pt-2 pb-2">
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-12">
                <h3 class="text-danger text-center align-items-center" style="font-family: Calibri">Coffee Bars</h3>
            </div>
        </div>
<?php
