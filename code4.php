...
$result=mysqli_query($con,"select * from alltables");
if(isset($_POST["submit"]))
{

$query = "SELECT * FROM alltables WHERE name = '$comment'";
...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item pt-2 pb-2">
                    <a href="Hotels.php" class="nav-link text-white"><span class="fa fa-home"></span> Hotels</a>
                </li>
                <li class="nav-item pt-2 pb-2">
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-12">
                <h3 class="text-danger text-center align-items-center" style="font-family: Calibri"><?php echo $row['name']; ?></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                <img class="img-fluid rounded" src=<?php echo $row['photo']; ?>>
            </div>
            <div class="col-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit" value=<?php echo $row['photo']; ?>>Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<H1><?php echo $comment; ?> was not found!</H1>
</body>
</html>
<?php
		}
